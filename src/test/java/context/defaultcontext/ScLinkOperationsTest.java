...
public class ScLinkOperationsTest {
    ...
    @Test
    @Timeout(value = 5000, unit = TimeUnit.MILLISECONDS)
    void createSingleBinaryLink() throws IOException, ScMemoryException {
    ...
    @Test
    @Timeout(value = 5000, unit = TimeUnit.MILLISECONDS)
    void getContentFromBinaryLink() throws IOException, ScMemoryException {
    ...
    @Test
    @Timeout(value = 5000, unit = TimeUnit.MILLISECONDS)
    void setContentToBinaryString() throws IOException, ScMemoryException {
        String oldStr = "Hello";
        String newStr = "Bye";
