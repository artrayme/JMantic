...
public class ScMemoryFindPatternTest {
    ...
    void findPatternOf3Edges() throws Exception {
        ScNode source1 = scMemory.createNodes(Stream.of(NodeType.NODE))
                                 .findFirst()
                                 .get();
        ScNode target1 = scMemory.createNodes(Stream.of(NodeType.NODE))
                                 .findFirst()
                                 .get();
        ...
        ScNode source2 = scMemory.createNodes(Stream.of(NodeType.NODE))
                                 .findFirst()
                                 .get();
        ScNode target2 = scMemory.createNodes(Stream.of(NodeType.NODE))
                                 .findFirst()
                                 .get();
